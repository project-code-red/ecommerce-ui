...
export function ProductCardHomepage({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-card hover:shadow-card-hover transition-all duration-200 overflow-hidden relative h-full flex flex-col">
        {/* Image Container */}
        <div className="relative aspect-square overflow-hidden bg-gray-50">
          ...
          {product.discountPercentage > 0 && (
            <Badge
              variant="warning"
              className="absolute top-2 left-2 z-10 font-bold text-xs px-2 py-0.5"
            >
