...
function CategoryContent({ params }: { params: Promise<{ main: string }> }) {
  ...
  const { data: allProductsData, isLoading: isLoadingAll } = useProducts(
    ...
    1,
    10000 // Large number to get all products for filtering
  );
  ...
  const filteredProducts = useMemo(() => {
    ...
    return sorted;
  }, [allProductsData, filters, debouncedSearch]);
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="flex relative">
        ...
        {/* Product Grid */}
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 pb-24 lg:pb-6">
          {/* Filter Chips */}
          <FilterChips
            filters={filters}
...
export default function CategoryPage({ params }: { params: Promise<{ main: string }> }) {
  return (
