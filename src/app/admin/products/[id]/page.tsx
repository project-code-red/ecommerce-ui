...
import { useUpdateProduct } from "@/services/queries/adminQueries";
import { useProductById } from "@/services/queries/productQueries";
...
export default function EditProductPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    if (product) {
      reset({
        ...
        subSubCategory: product.subSubCategory?.toLowerCase() || "",
  ...
  if (!product) {
    return <div className="max-w-4xl mx-auto px-4 py-8">Product not found</div>;
  }
